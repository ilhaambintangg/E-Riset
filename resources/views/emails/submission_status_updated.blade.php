                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #4a5568;">
                                Status permohonan izin penelitian Anda (<strong>{{ $submission->registration_number }}</strong>) telah diperbarui oleh sistem administrasi kami.
                            </p>
                            ...
                            <p style="margin: 0 0 30px 0; font-size: 15px; line-height: 1.6; color: #4a5568; font-style: italic;">
                                Silakan login atau cek status pengajuan secara berkala melalui tautan resmi di bawah ini untuk mengunduh dokumen yang diperlukan.
                            </p>

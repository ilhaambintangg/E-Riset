...
<div x-data="{ showModal: false, isEdit: false, form: { id: '', nama_panitera: '', jabatan: '', status_aktif: 1 } }">
    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button @click="isEdit = false; form = { id: '', nama_panitera: '', jabatan: '', status_aktif: 1 }; showModal = true" 
                    ...
                    @forelse($paniteras as $p)
                        <tr class="hover:bg-neutral-primary-soft transition-colors">
                            ...
                            <td class="px-6 py-4 text-right space-x-1">
                                <button @click="isEdit = true; form = { id: '{{ $p->id }}', nama_panitera: '{{ addslashes($p->nama_panitera) }}', jabatan: '{{ addslashes($p->jabatan) }}', status_aktif: {{ $p->status_aktif }} }; showModal = true" 
